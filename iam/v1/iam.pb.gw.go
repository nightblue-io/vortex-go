...
func request_Iam_SignUp_0(ctx context.Context, marshaler runtime.Marshaler, client IamClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Iam_SignUp_0(ctx context.Context, marshaler runtime.Marshaler, server IamServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SignUpRequest
	var metadata runtime.ServerMetadata
...
func RegisterIamHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IamServer) error {
	...
	mux.Handle("POST", pattern_Iam_SignUp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Iam_SignUp_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Iam_SignUp_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIamHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IamClient) error {
	...
	mux.Handle("POST", pattern_Iam_SignUp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Iam_SignUp_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
